...
use crate::{application::ports::{ActivityRepository, UserRepository }, domain::{activity::Points, user::{ User, UserId}}};
...
pub fn get_leaderboard(activity_repo: &impl ActivityRepository, user_repo: &impl UserRepository) -> Leaderboard {
